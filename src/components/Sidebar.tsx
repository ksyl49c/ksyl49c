...
const nav = [
  ...
  { to: "/resources", label: "Resource Management", icon: Radar },
  { to: "/monitoring", label: "Resident Monitoring", icon: HeartPulse },
      ...
      <div className="p-3 border-t border-ink-100">
        <div className="flex items-center gap-2.5 rounded-xl px-2.5 py-2.5 hover:bg-ink-100 transition-colors cursor-pointer">
          ...
          <div className="min-w-0">
            ...
            <div className="text-xs text-ink-400 truncate">Director of Nursing</div>
          </div>
        </div>
      </div>
    </aside>
