...
import { voiceCaptures, residentById } from "../lib/mockData";

type Stage = "idle" | "recording" | "transcribing" | "structuring" | "done";

const categoryIcon: Record<string, typeof FileText> = {
  "Nursing Note": FileText,
  "Care Plan Update": ClipboardList,
  "Wound Assessment": ClipboardList,
  "MAR Comment": ClipboardList,
  "Shift Handover": FileText,
  "Fall Report": ShieldAlert,
  "Safeguarding Flag": ShieldAlert,
  "Near Miss Log": ShieldAlert,
};
        ...
        <div className="space-y-5">
          <Card className="text-center">
            ...
            <p className="text-xs text-ink-400 mt-4 leading-relaxed">
              Worn device auto-detects clinical speech during rounds &mdash; no manual start needed on the floor. Demo playback shown here.
            </p>
          </Card>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs text-ink-400">
                        {residentById(c.residentId)?.name} &middot; {c.timestamp}
                      </div>
                    </div>
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-xs text-ink-400">
                    re: {residentById(activeCapture.residentId)?.name} &middot; {activeCapture.timestamp} &middot; {activeCapture.durationSec}s
                  </div>
                </div>
              </div>
              {isDemoActive && (
