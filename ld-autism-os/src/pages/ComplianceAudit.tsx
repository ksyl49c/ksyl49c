...
import { auditItems, incidents, upcomingAudits } from "../lib/mockData";
...
export default function ComplianceAudit() {
  ...
  const restrictivePracticeIncidents = incidents.filter((i) => i.type === "Restrictive Practice");
  ...
  return (
    <div className="animate-fade-in-up">
      <SectionHeading
        ...
        description="Every voice-captured ABC chart, restrictive practice log, and PBS review feeds a live regulatory ledger — covering CQC, DoLS/LPS, STOMP medication reviews, and Oliver McGowan training, so nothing is reconstructed the night before an inspection."
      />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <StatTile label="Next inspection" value="9 days" sub="CQC Inspection" tone="sky" />
      </div>
        ...
        <div className="space-y-5">
          ...
          <Card className="bg-rose-50 border-rose-200">
            ...
            <p className="text-xs text-rose-700/80 leading-relaxed">
              {restrictivePracticeIncidents.length} restrictive practice incident(s) logged this week — 1 not yet
              submitted to CQC/local authority within the statutory timeframe. Voice-captured restrictive practice
              logs auto-check for submission deadlines.
            </p>
          </Card>
        </div>
      </div>
